...
<body>
    ...
    <div class="container" style="width:600px;">
        ...
        while($row = mysqli_fetch_assoc($result)) {
            echo "<h4>" . $row["itemName"] ." - ₹" . $row["itemPrice"]."</h4>" 
            . "<h6>" . $row["itemDesc"] ."</h6>";
            echo "<form class='reg-form' action='includes/listing.inc.php' method='post'>
            ...
            . "<button type='submit' name='submit'>Offer</button></form><br>";
            }
        } 
        else {
        echo "0 results";
